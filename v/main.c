...
VV_LOCAL_SYMBOL int compare_14052015146937452785_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_14052015146937452785_RepIndex_by_idx);
	byte* b = malloc_noscan(new_len + 1);
	int idx_pos = 0;
